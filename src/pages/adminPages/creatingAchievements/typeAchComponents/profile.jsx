  ...
  useEffect(() => {
    ...
    return (
        <div className={classes.columnBlock}>
          <h3 className={classes.titleMinPlock}>Профиль</h3>
          <div className={classes.AppealsBlock}>
            ...
            <div>
              <p className={classes.AppealsP}>Достигнуть определенного уровня</p>
              <Select
                id="valueThemeSelect"
                sx={{ ...selecetStyle, marginTop: "0" }}
                value={0}
              ...
              <p className={classes.AppealsP}>Заработано наград</p>
              <Select
                id="valueThemeSelect"
                sx={{ ...selecetStyle, marginTop: "0" }}
                value={0}
