...
const Rating = () => {
  ...
  return (
    <div className={classes.columnBlock}>
      <h3 className={classes.titleMinPlock}>Рейтинг</h3>
      <div className={classes.AppealsBlock}>
        ...
        <div>
          <p className={classes.AppealsP}>Занять топ 1 несколько раз подряд (по А-коинам, опыту, карме, общий топ)</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
          ...
          Занять топ 1 (по А-коинам, опыту, карме, общий топ) 
          </p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
          ...
          <p className={classes.AppealsP}>Занять топ 2 (по А-коинам, опыту, карме, общий топ)</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
          ...
          </Select>{" "}<p className={classes.AppealsP}>Занять топ 3 (по А-коинам, опыту, карме, общий топ)</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
