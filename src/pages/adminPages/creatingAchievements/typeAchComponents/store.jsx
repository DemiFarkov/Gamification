...
const Store = () => {
  ...
  return (
    <div className={classes.columnBlock}>
      <h3 className={classes.titleMinPlock}>Инвентарь/Магазин</h3>
      <div className={classes.AppealsBlock}>
        ...
        <div>
          <p className={classes.AppealsP}>Куплено предметов в магазине</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
          ...
          <p className={classes.AppealsP}>Предметов в инвентаре</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
          ...
          <p className={classes.AppealsP}>Куплено удаленок (достижение по типу, “Король удаленки”) и так с другими товарами</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
