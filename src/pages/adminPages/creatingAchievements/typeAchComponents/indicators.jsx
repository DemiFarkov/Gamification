...
const Indicators = () => {
  ...
  return (
    <div className={classes.columnBlock}>
      <h3 className={classes.titleMinPlock}>Показатели</h3>
      <div className={classes.AppealsBlock}>
        ...
        <div>
          <p className={classes.AppealsP}>Заработано кармы</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
          ...
          <p className={classes.AppealsP}>Заработать А-коинов</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
          ...
          <p className={classes.AppealsP}>Заработать кармы за (день, неделю, месяц)</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
          ...
          <p className={classes.AppealsP}>Заработано А-коинов за (день, неделю, месяц)</p>
          <Select
            id="valueThemeSelect"
            sx={{ ...selecetStyle, marginTop: "0" }}
            value={0}
